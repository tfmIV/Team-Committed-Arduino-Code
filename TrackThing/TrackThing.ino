...
void onward(int sped, int newLeft, int newRight) {
   int positionLeft = newLeft;
   int positionRight = newRight;
...
while((sensor.readRangeContinuousMillimeters()>70)) {
newLeft = knobLeft.read();
newRight = -knobRight.read();
onward(50,newLeft,newRight);
if (newLeft != positionLeft || newRight != positionRight) {
   Serial.print("Left = ");
   Serial.print(newLeft);
   Serial.print(", Right = ");
...
int startingLeft = knobLeft.read();
int startingRight = knobRight.read();
onward(50,startingLeft,startingRight);
if (newLeft != positionLeft || newRight != positionRight) {
   Serial.print("Left = ");
   Serial.print(newLeft);
   Serial.print(", Right = ");
